...
class CategoriesController {
    ...
    create = async (req, res, next) => {
        try {
            ...
            LogModel.create({
                action: `Create the category ${data.description}`
              });
    ...
    update = async (req, res, next) => {
        try {
            ...
            LogModel.create({
                action: `Update the category ${data.description}`
              });
    ...
    delete = async (req, res, next) => {
        ...
        LogModel.create({
            action: `Delete the category ${req.params.categoryId}`
          });
    ...
    _validateData = async (data, id) => {
        ...
        if (await this._checkIfDescriptionExists(category.description, id)) {
            throw new Error(`The category with category "${category.description}" already exists.`);
        }
